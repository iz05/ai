...
# version 14: implements opening book and piece stability

x_opening_book = {
    "...........................ox......xo..........................." : 37, # opening position
    "...........................ox......xox.......o.................." : 44, # play the cross
    "...........................ox......xo.......xo.................." : 36, # play the cross
...
def stable_helper(board, piece, pos, h, v):
    x = pos // 8
    y = pos % 8
    i = x
    j = y
    while i >= 0 and i < 8:
        while j >= 0 and j < 8:
            if board[8 * i + j] == ".":
                return False
            if piece != board[8 * i + j]:
                return False
            j += v
        i += h
    return True

def stable(board, piece, pos):
    return stable_helper(board, piece, pos, 1, 1) or stable_helper(board, piece, pos, 1, -1) or stable_helper(board, piece, pos, -1, 1) or stable_helper(board, piece, pos, -1, -1)
