...
# VERSION 2: implement linear conflict heuristic
        ...
        if state[2] not in closed:
            ...
            for child, num in get_children(state[2]):
                if child not in closed:
                    tup = (
                        taxicab(SIZE, child) + conflict_heuristic(child) + state[1] + 1,
...
# Testing heuristic
# print(conflict_heuristic("AC.OIBMLHEDKJGFN"))
print(a_star(4, "IABDNECJ.FKHMOGL"))